...
public class HoughTransform extends Thread {
    ...
    public static void main(String[] args) throws Exception {
        String filename = "src/test/resources/roadxr_not11.png";
        ...
        System.out.println(h.numPoints);

        // get the lines out
        Vector<HoughLine> lines = h.getLines(2);
        ...
        for (int j = 0; j < lines.size(); j++) {
            ...
            line.draw(imageOut, Color.RED.getRGB());
        }

        FileOutputStream fos = new FileOutputStream(new File("src/test/resources/out.png"));
        ImageIO.write(imageOut, "png", fos);
    }
