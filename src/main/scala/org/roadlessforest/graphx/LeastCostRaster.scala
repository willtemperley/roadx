...
object LeastCostRaster {
  ...
  def main (args: Array[String]): Unit = {
    ...
    //Get raster
    val raster = TestResources.getTestRaster("cost_test.tif")
     ...
     * Given a random
     */
    def getVertexIds(r0: Int, c0: Int, r1: Int, c1: Int): Seq[Edge[Boolean]] = {
      val idx0 = sub2ind(r0, c0)
      val idx1 = sub2ind(r1, c1)
      val diag = (r0 != r1) && (c0 != c1)
      Seq(Edge(idx0, idx1, diag), Edge(idx1, idx0, diag))
    }
    ...
    val G = g.mapTriplets((f: EdgeTriplet[(PartitionID, PartitionID, PartitionID), Boolean]) => cost(f.srcAttr._3, f.dstAttr._3, f.attr))
